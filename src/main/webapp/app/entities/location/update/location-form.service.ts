...
type LocationFormGroupContent = {
  ...
  lattitude: FormControl<LocationFormRawValue['lattitude']>;
  longtitude: FormControl<LocationFormRawValue['longtitude']>;
...
export class LocationFormService {
  createLocationFormGroup(location: LocationFormGroupInput = { id: null }): LocationFormGroup {
    ...
    return new FormGroup<LocationFormGroupContent>({
      ...
      lattitude: new FormControl(locationRawValue.lattitude, {
        validators: [Validators.required],
      }),
      longtitude: new FormControl(locationRawValue.longtitude, {
        validators: [Validators.required],
      }),
