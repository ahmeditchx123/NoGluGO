...
/**
 * Criteria class for the {@link com.noglugo.mvp.domain.Article} entity. This class is used
 * in {@link com.noglugo.mvp.web.rest.ArticleResource} to receive all the possible filtering options from
...
public class ArticleCriteria implements Serializable, Criteria {
    ...
    public UUIDFilter getCommentsId() {
        return commentsId;
    }

    public UUIDFilter commentsId() {
        if (commentsId == null) {
            commentsId = new UUIDFilter();
        }
        return commentsId;
    }

    public void setCommentsId(UUIDFilter commentsId) {
