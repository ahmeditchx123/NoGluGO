...
/**
 * Criteria class for the {@link com.noglugo.mvp.domain.Review} entity. This class is used
 * in {@link com.noglugo.mvp.web.rest.ReviewResource} to receive all the possible filtering options from
...
public class ReviewCriteria implements Serializable, Criteria {
    ...
    public UUIDFilter getMenuItemId() {
        return menuItemId;
    }

    public UUIDFilter menuItemId() {
        if (menuItemId == null) {
            menuItemId = new UUIDFilter();
        }
        return menuItemId;
    }

    public void setMenuItemId(UUIDFilter menuItemId) {
