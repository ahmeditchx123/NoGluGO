...
public class CartItem implements Serializable {
    ...
    public CartItem totalPrice(Double totalPrice) {
    ...
    public CartItem createdBy(String createdBy) {
    ...
    public CartItem lastModifiedBy(String lastModifiedBy) {
    ...
    public void setProducts(Set<Product> products) {
        if (this.products != null) {
            this.products.forEach(i -> i.setCartItem(null));
        }
        if (products != null) {
            products.forEach(i -> i.setCartItem(this));
        }
        this.products = products;
    }

    public CartItem products(Set<Product> products) {
        this.setProducts(products);
        return this;
    }

    public CartItem addProducts(Product product) {
        this.products.add(product);
        product.setCartItem(this);
        return this;
    }

    public CartItem removeProducts(Product product) {
