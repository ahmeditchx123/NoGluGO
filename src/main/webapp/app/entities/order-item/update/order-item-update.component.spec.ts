...
describe('OrderItem Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Order query and add missing value', () => {
      const orderItem: IOrderItem = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const order: IOrder = { id: '614f9fd1-aff7-414d-8ff3-3ce74623dbc3' };
      orderItem.order = order;

      const orderCollection: IOrder[] = [{ id: '2f5486da-327d-42e0-956b-943ab2324938' }];
    ...
    it('Should update editForm', () => {
      const orderItem: IOrderItem = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const order: IOrder = { id: '79254696-0c5b-482d-ba9f-5a660cb22238' };
      orderItem.order = order;
  ...
  describe('save', () => {
    it('Should call update service on save for existing entity', () => {
      ...
      const orderItem = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
