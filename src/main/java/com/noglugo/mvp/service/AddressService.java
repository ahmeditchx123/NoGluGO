...
/**
 * Service Interface for managing {@link com.noglugo.mvp.domain.Address}.
 */
public interface AddressService {
    ...
    /**
     * Get all the AddressDTO where Location is {@code null}.
     *
     * @return the {@link List} of entities.
     */
    List<AddressDTO> findAllWhereLocationIsNull();
    ...
    Optional<AddressDTO> findOneByUserId(Long userId);
}
