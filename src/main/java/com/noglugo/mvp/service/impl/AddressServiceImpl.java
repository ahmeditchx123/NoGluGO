...
import com.noglugo.mvp.service.AddressService;
...
public class AddressServiceImpl implements AddressService {
    ...
    @Override
    public Optional<AddressDTO> findOneByUserId(Long userId) {
        return addressRepository.findByUserIdEquals(userId).map(addressMapper::toDto);
    }
}
