...
/**
 * Service Interface for managing {@link com.noglugo.mvp.domain.Store}.
 */
public interface StoreService {
    ...
    /**
     * Get all the StoreDTO where StoreAddress is {@code null}.
     *
     * @return the {@link List} of entities.
     */
    List<StoreDTO> findAllWhereStoreAddressIsNull();
     ...
     * @return the entity.
     */
    Optional<StoreDTO> findOne(UUID id);
    ...
    Optional<StoreDTO> findOneByUserId(Long userId);
}
